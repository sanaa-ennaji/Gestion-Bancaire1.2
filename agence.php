...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["delete_agency"])) {
    ...
    $sql = "DELETE FROM agencies WHERE id = $agency_id";
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        echo "Error deleting agence: " . mysqli_error($conn);
    }
}
ob_end_flush(); 
?>
...
<div class="d-flex p-5 justify-content-between">
   <h1>agences list list</h1>
  <a href="addAGENCE.php"> <i data-feather="plus-circle"></i></a>
</div>
</div>
    <table class="table">
        <thead>
                ...
                echo "<tr>
                        ...
                        <td>
                            <form action='{$_SERVER['PHP_SELF']}' method='post'>
                                ...
                                <button type='submit' class='btn btn-danger' name='delete_agency'>Delete</button>
                            </form>
                        </td>
                      </tr>";
