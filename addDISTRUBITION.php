...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link" href="distrubition.php"><i data-feather="corner-down-left"></i> Back to Banks</a>
      </li>
    </ul>
  </div>
</nav>
...
<div class="d-flex p-5 justify-content-between">
   <h1> add  distributeurs </h1>
    ...
    <input type="text" class="form-control" name="bank_id" required>
        ...
        <button type="submit" class="btn btn-primary"> add distributeurs </button>
    </form>
    <script>
      feather.replace();
    </script>
